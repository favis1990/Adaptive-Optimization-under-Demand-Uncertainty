#Deterministic function 10.30.2021
#Objective function includes opening and setup cost of warehouses
#lead time constraint is added
# less index
import xlrd
import time
import numpy as np
...
def detsim(jj,kk,tt,rr,ww,q_p,q_w,c_b,h,p,transperunit,CAP,D_W,o_p,o_w,q,sigma,bigM,C_O_W,Y_det,podcost_det,dis_per_unit,ini_inv,carpi):
    RCstart = time.time()
    ''' Model '''

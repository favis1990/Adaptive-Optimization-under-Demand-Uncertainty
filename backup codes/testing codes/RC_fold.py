# Deterministic function for folding horizon 
# less index
import xlrd
import time
import numpy as np
...
def RC_fold(carpi,jj,kk,tt,rr,ww,q_p,q_w,c_b,h,p,transperunit,CAP,D_W,o_p,o_w,q,sigma,bigM,C_O_W,ini_inv,k_1,fold_X,fold_Y, fold_Z,fold_I,period,dis_per_unit):
    RCstart = time.time()
    ''' Model '''

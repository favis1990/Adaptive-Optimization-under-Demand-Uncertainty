#ARC milk job functon using fixed Z_P_V 27.10.2021
# less index
...
def ARC(jj,kk,tt,rr,ww,q_p,q_w,c_b,h,p,transperunit,CAP,D_W,dz,dh,o_p,o_w,q,sigma,bigM,openingPN,setupfirstN,costopenN,Z_P_V,ini_inv,k_1) :
    ARCstart = time.time()
    ''' Model '''

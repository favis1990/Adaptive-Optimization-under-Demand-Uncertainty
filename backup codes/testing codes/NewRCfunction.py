# Deterministic function 26.10.2021 ( robust by zarb kardan dar zeta+1)
#revised 2023 may 17
# less index
...
def RC(jj,kk,tt,rr,ww,q_p,q_w,c_b,h,p,transperunit,CAP,D_W,o_p,o_w,q,sigma,bigM,C_O_W,ini_inv,k_1):
    RCstart = time.time()
    ''' Model '''
...
# =============================================================================
#     mdl.add_constraints(I[(w,0,k,tt-1)]==ini_inv[(w,0,k)] for w in range (ww)for k in range (kk))
#     mdl.add_constraints(I[(w,1,k,tt-1)]==ini_inv[(w,1,k)] for w in range (ww)for k in range (kk))
#     mdl.add_constraints(I[(w,2,k,tt-1)]==ini_inv[(w,2,k)] for w in range (ww)for k in range (kk))
#     mdl.add_constraints(I[(w,3,k,tt-1)]==ini_inv[(w,3,k)] for w in range (ww)for k in range (kk))
#     mdl.add_constraints(I[(w,4,k,tt-1)]==ini_inv[(w,4,k)] for w in range (ww)for k in range (kk))
#     mdl.add_constraints(I[(w,5,k,tt-1)]==ini_inv[(w,5,k)] for w in range (ww)for k in range (kk))
# =============================================================================

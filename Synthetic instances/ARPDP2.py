#ARC milk job functon using Z binary decison variables
#[ARPDP]
...
def ARC2(jj, kk, tt, rr, ww, q_p, q_w, c_b, h, p, transperunit, CAP, D_W, dz, dh, o_w, q, sigma, bigM, C_O_W,  ini_inv) :    
    ARCstart = time.time()
    ''' Model '''
